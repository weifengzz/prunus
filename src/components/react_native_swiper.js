 ...
 * @description https://github.com/leecade/react-native-swiper
 */
...
class RNSwiper extends Component {
  ...
  renderScrollView (pages) {
    if (Platform.OS === 'ios') {
      return (
        <ScrollView ref={(view) => this.refScrollView(view)}
          {...this.props}
    ...
    return (
      <ViewPagerAndroid ref={(view) => this.refScrollView(view)}
        {...this.props}
  ...
  render () {
    ...
    return (
      <View style={[styles.container, containerStyle]} onLayout={(e) => this.onLayout(e)}>
